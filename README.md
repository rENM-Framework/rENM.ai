...
Within the modular rENM ecosystem, `rENM.ai`: - Assembles **AI-ready data packages** from rENM outputs - Submits structured inputs to large language models - Generates **narrative reports (DOCX)** from analytical results - Standardizes AI prompts and output formats
